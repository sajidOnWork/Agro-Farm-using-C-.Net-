...
namespace AgroFarm
{
    public partial class AddWarehouseStatus : Form
    {
        ...
        private void AddWarehouseStatus_Load(object sender, EventArgs e)
        {
        ...
        private void Button7_Click(object sender, EventArgs e)
        {
            try
            {
                m.Close();
                m.Open();
                SqlCommand cmd = new SqlCommand("insert into [dbo].[warehouse](Wname,FoodName,Quantity) values ('" + textBox2.Text + "', '" + textBox3.Text + "', '" + textBox4.Text + "')", m);
