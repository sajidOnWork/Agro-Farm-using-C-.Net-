...
namespace AgroFarm
{
    public partial class WarehouseStatusReport : Form
    {
        ...
        private void WarehouseStatusReport_Load(object sender, EventArgs e)
        {
            try
            {
                m.Close();
                m.Open();
                SqlDataAdapter cmd = new SqlDataAdapter("select * from [dbo].[warehouse]", m);
        ...
        private void Button7_Click(object sender, EventArgs e)
        {
            try
            {
                m.Close();
                m.Open();
                SqlCommand cmd = new SqlCommand("delete from [dbo].[warehouse] where Wid='" + textBox1.Text + "'", m);
                ...
                if (a > 0)
                {
                    ...
                    this.Hide();
                    WarehouseStatusReport f1 = new WarehouseStatusReport();
                    f1.Show();
                }
                else
                {
        ...
        private void Button8_Click(object sender, EventArgs e)
        {
            try
            {
                m.Close();
                m.Open();
                SqlCommand cmd = new SqlCommand("update [dbo].[warehouse] set Wname = '" + textBox2.Text + "', FoodName = '" + textBox3.Text + "', Quantity = '" + textBox4.Text + "'  where Wid='" + textBox1.Text + "'", m);
                int a = cmd.ExecuteNonQuery();
                if (a > 0)
                {
